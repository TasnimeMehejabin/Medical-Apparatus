...
$sql = "SELECT * FROM doctor_name ORDER BY doc_id desc";
...
<div align="right" style="padding-bottom:5px;"><a href="doc_form.php" ><img alt='Add' title='Add' src='add.png' width='24px' height='24px'/><font size="4"> Add new data</font></a></div>
...
<td align="center"><a onclick="return  confirm('sure!want to delete this data')" href="delete_doctor_data.php ?doc_id=<?php echo $row["doc_id"]; ?>" >
